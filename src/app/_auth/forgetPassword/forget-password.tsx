...
import { forgetAction, registerAction } from '@/lib/actions/auth.action';

const ForgetPasswordModal = ({ isOpen, onClose, onOpenForget }: { isOpen: boolean; onClose: () => void; onOpenForget: () => void }) => {
